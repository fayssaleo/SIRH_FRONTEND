        ...
        <v-card class="">
          <v-card-title style="background-color: #87b0e6">
            <span class="headline" style="color: white"
              >{{ posteContent.departementName + " - " + posteContent.libelle }}
              :
            </span>
          </v-card-title>
          <v-card-text>
            <v-container class="container">
              <v-row>
                <v-col cols="12" class="pt-0 pb-0">
                  <span class="dateTitle">Details :</span>
                  <span class="textForDecisionText">
                    {{ posteContent.fichePoste }}
                  </span>
                </v-col>
              </v-row>
              <v-row>
                <v-col cols="12" class="pt-0 pb-0 mb-2">
                  <span class="annuler" @click="closeDialog"> FERMER </span>
                </v-col>
              </v-row>
            </v-container>
          </v-card-text>
...
export default {
  ...
  mounted: function () {
    //console.log("this.dialog", this.startDate);
  },
};
</script>
