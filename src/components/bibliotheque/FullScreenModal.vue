<template>
  <v-row justify="center" @keydown="exit">
    <v-dialog
      v-model="dialog"
      fullscreen
      height="100%"
    ...
    >
      <v-card>
        <v-card-text>
          <v-container class="container" style="max-width: 100% !important">
            <b-row>
              <b-col
                cols="12"
                class="pdfContainer"
                style="position: relative; padding-top: 51px"
              >
