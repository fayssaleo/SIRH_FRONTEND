...
export default {
  ...
  methods: {
    ...mapActions([
      "addDocuments_categorieAction",
      "editDocuments_categorieAction",
      "deleteDocuments_categorieAction",
    ]),
    closeDialog() {
      this.dialog = false;
    },
    ...
    categorieSelectChange() {
      let categorieToEdit = this.getDocuments_categories.filter(
    ...
    categorie_submit() {
      ...
      if (this.isValid) {
        if (this.modeAdd) {
          this.addDocuments_categorieAction(this.categorie).then(() => {
            this.infoFieldsDisabled = true;
            this.categorie = {
              id: null,
              libelle: "",
          ...
          this.editDocuments_categorieAction(this.categorie).then(() => {
            this.infoFieldsDisabled = true;
            this.categorie = {
              id: null,
              libelle: "",
    ...
    deleteCategorie() {
      this.deleteDocuments_categorieAction({
