<template>
  <b-row class="content m-0 p-0">
    <b-col cols="12" class="sidebar-logo">
      <img src="@/assets/Devcorp-LOGO-big-6@2x.png" align-h="center" alt="" />
    </b-col>

    <b-col cols="12" class="menu mt-4">
      <ul id="menuList">
          ...
          <li>
            <span>
              <svg
                ...
                width="18.947"
                height="18.949"
                viewBox="0 0 18.947 18.949"
              >
                <defs></defs>
                <path
                  class="a"
                  d="M18.938,8.241h0L11.207.51A1.744,1.744,0,0,0,8.74.51L1.014,8.236l-.008.008a1.744,1.744,0,0,0,1.161,2.972l.054,0h.308v5.688a2.044,2.044,0,0,0,2.042,2.042H7.595a.555.555,0,0,0,.555-.555v-4.46A.933.933,0,0,1,9.082,13h1.784a.932.932,0,0,1,.931.931v4.46a.555.555,0,0,0,.555.555h3.024a2.044,2.044,0,0,0,2.042-2.042V11.218H17.7a1.745,1.745,0,0,0,1.235-2.977Zm-.786,1.681a.63.63,0,0,1-.448.186h-.841a.555.555,0,0,0-.555.555v6.243a.932.932,0,0,1-.931.931H12.907v-3.9a2.044,2.044,0,0,0-2.042-2.042H9.082A2.044,2.044,0,0,0,7.04,13.933v3.9H4.571a.933.933,0,0,1-.931-.931V10.663a.555.555,0,0,0-.555-.555H2.232A.633.633,0,0,1,1.8,9.025h0L9.525,1.3a.634.634,0,0,1,.9,0l7.728,7.727,0,0a.636.636,0,0,1,0,.9Zm0,0"
...
.content {
  ...
  box-shadow: 6px 3px 15px #4762f129;
  opacity: 1;
  width: 280px;
}
.sidebar-logo {
